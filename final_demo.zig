...
pub fn main() !void {
    ...
    std.debug.print("\nNEO ZIG SDK: DEMO COMPLETE\n", .{});
    std.debug.print("OK: Core types and crypto are functional\n", .{});
    std.debug.print("OK: Run `zig build test` for full suite\n", .{});
    std.debug.print("NOTE: Network calls require a Neo N3 node\n", .{});
}
