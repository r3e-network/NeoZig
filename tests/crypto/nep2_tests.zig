...
test "NEP-2 error conditions" {
    ...
    try testing.expectError(@import("../../src/crypto/nep2_error.zig").NEP2Error.InvalidPassword, NEP2.decrypt(
        "wrongpassword",
        defaultAccountEncryptedPrivateKey,
        ScryptParams.default(),
        allocator,
    ...
    try testing.expectError(@import("../../src/crypto/nep2_error.zig").NEP2Error.InvalidEncryptedKey, NEP2.decrypt(
        defaultAccountPassword,
        "invalidencryptedkey",
        ScryptParams.default(),
        allocator,
