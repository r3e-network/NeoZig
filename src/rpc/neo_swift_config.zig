...
pub const NeoSwiftConfig = struct {
    ...
    pub fn encodeToJson(self: Self, allocator: std.mem.Allocator) ![]u8 {
        ...
        return try std.fmt.allocPrint(allocator, "{{\"networkMagic\":{s},\"blockInterval\":{},\"maxValidUntilBlockIncrement\":{},\"pollingInterval\":{},\"allowsTransmissionOnFault\":{},\"nnsResolver\":\"{s}\"}}", .{
            network_magic_str,
            self.block_interval,
