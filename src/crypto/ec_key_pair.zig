...
//!
//! Neo N3
//! Provides SECP-256r1 key pair management.
...
pub const ECKeyPair = struct {
    ...
    /// Validates key pair consistency
...
test "ECKeyPair creation and basic operations" {
    ...
    // Test random key pair creation tests)
...
test "ECKeyPair creation from private key" {
    ...
    // Test creation from bytes tests)
