...
test "NeoSwiftRx creation and basic operations" {
    ...
    var json_rpc_rx = JsonRpc2_0Rx.init(allocator, null, executor);
...
test "ReactiveUtils utility functions" {
    ...
    try testing.expectError(
        ...
        ReactiveUtils.validatePollingInterval(500) // Too fast
    );
    
    try testing.expectError(
        errors.ValidationError.ParameterOutOfRange,
        ReactiveUtils.validatePollingInterval(400000) // Too slow
    );
